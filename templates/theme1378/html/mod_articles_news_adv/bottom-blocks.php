...
defined('_JEXEC') or die;
  ...
  if($columns == 0){
    $spanClass = 'span'.floor($params->get('bootstrap_size')/$n);
  } elseif($columns == 1){
    $spanClass = '';
  } else {
...
<div class="mod-newsflash-adv mod-newsflash-adv__<?php echo $moduleclass_sfx; ?>">
  ...
  <?php endif; ?>
    ...
    ?>
      ...
      <div class="<?php echo $spanClass; ?> item item_num<?php echo $i; ?> item__module">
      		<strong class="dropcap"><?php echo '0' . ($i+1) . '/'; ?></strong>
          <?php require JModuleHelper::getLayoutPath('mod_articles_news_adv', '_bottom-blocks_item'); ?>
      </div>
