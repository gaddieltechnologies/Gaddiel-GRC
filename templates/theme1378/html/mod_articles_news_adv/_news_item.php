...
?>
	...
	<?php if ($params->get('published')) : ?>
		<div class="item_published">
			<?php echo JHtml::_('date', $item->publish_up, JText::_('DATE_FORMAT_TPL3')); ?>
			<span><?php echo JHtml::_('date', $item->publish_up, JText::_('DATE_FORMAT_TPL2')); ?></span>
		</div>
	<?php endif; ?>
...
<div class="item_content">
	...
	<?php if (isset($item->link) && $item->readmore != 0 && $params->get('readmore')) :
		echo '<a class="btn btn-info readmore" href="'.$item->link.'"></span>'.JText::_('TPL_COM_CONTENT_READ_MORE').'</span></a>';
	endif; ?>
